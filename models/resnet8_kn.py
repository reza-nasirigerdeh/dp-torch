...
class ResNet8KN(nn.Module):
    def __init__(self, num_classes=10, activation=nn.ReLU,  knconv_dropout_p=0.1, kn_dropout_p=0.25):
        """ 8-layer kernel normalized residual network """
        super(ResNet8KN, self).__init__()

        self.conv_block1 = knconv_block(in_channels=3, out_channels=64, activation=activation, max_pool=False, knconv_dropout_p=knconv_dropout_p)
        ...
        self.res_block1 = ResidualBlockKN(in_channels=128, out_channels=128, activation=activation, knconv_dropout_p=knconv_dropout_p)
        ...
        self.res_block2 = ResidualBlockKN(in_channels=256, out_channels=256, activation=activation, knconv_dropout_p=knconv_dropout_p)
...
def resnet8_kn(num_classes=10, activation=nn.ReLU, knconv_dropout_p=0.1, kn_dropout_p=0.25):
    return ResNet8KN(num_classes, activation, knconv_dropout_p, kn_dropout_p)
